...
export default function Hero() {
  return (
    <section
      id="hero"
      className="bg-gradient-to-br from-white to-[var(--ultracardio-gray)] pt-20 px-2 sm:px-8 lg:px-16 h-[600px] flex items-center cursor-default"
    >
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight">
              ...
              <span className="text-[var(--ultracardio-red)]">excelência</span>{" "}
              e carinho
            </h1>
            <p className="text-lg text-gray-600 mb-6">
              Especialistas em cardiologia com tecnologia de ponta e atendimento
              humanizado para cuidar da sua saúde cardiovascular.
            </p>
            <a
